                ...
                <form>
                    ...
                    <div class="row">
                        <div class="col mb-3 custom-form-input">
                            ...
                            <input type="text" class="form-control" id="firstNameInput" placeholder="Name *" style="width: 225px;">
                        </div>
                        ...
                        <div class="col mb-3 custom-form-input" style="margin-right: 55px;">
                            ...
                            <input type="text" class="form-control" id="lastNameInput" placeholder="Last name *" style="width: 225px; margin-left:-100px;">
                        </div>
                    </div>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="login" id="signup" class="btn btn-lg start-50 rounded-pill">Sign up</button>
                    </div>
                </form>

                <div class="text-center mt-4">
                    <hr class="my-0" style="width: 80%; margin:auto; margin-right: 40px;" />
                    <p class="mt-3">Already have an account? <a href="../views/signin.php" class="signup-link">Sign in</a></p>
                </div>
