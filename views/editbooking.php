...
if (isset($_POST["updateflight"])) {
    $AdminFunctions->updatebooking();
}

if (isset($_GET['id'])) {
    $tripid = $_GET['id'];

    $sql = "SELECT * FROM bookings WHERE id = $tripid";
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="user_id" required>
                                <option value="<?php  echo $tripdetails['user_id']?>" selected>
                                    <?php echo $tripdetails['user_id']; ?>
                                </option>
                        ...
                        <div class="mb-3">
                            <input type="submit" name="updateflight" value="update booking"
