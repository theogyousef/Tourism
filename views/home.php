...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-person"></i><br>Sign in</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <video id="myVideo" width="1500px" height="850px" autoplay loop muted>
                    <source src="y2mate.is - This is Egypt-mfxQy5A_tHs-720p-1714078248.mp4" type="video/mp4">
                </video>
            </div>


            <div class="carousel-item">
                <img src="../public/photos/slider4.jpg" class="d-block custom-size mx-auto" alt="Egypt" width="1500" height="700">
                <div class="carousel-caption1">

                </div>
            </div>
            <div class="carousel-item">
                <img src="../public/photos/aswan1.jpg" class="d-block w-100" alt="..." height="700">
            </div>
        </div>
                    ...
                    <div class="container-simple-text__container-text container-simple-text__container-text--desktop-center container-simple-text__container-text--mobile-center text-center">
                        <div class="container-simple-text__container-text__fs-28-38">
                            <h2 class="container-simple-text__title mb-0" style="margin-top: 100px; color: #13315C;">
                                Landscapes that will take your breath away, rich <br> history, and delicious food, your trip to Egypt will be <br>nothing short of unforgettable.
                            </h2>
                        </div>
                    </div>
                </div>
    ...
    <section class="featured-destinations py-5">
        <div class="container">
            ...
            <h1 class="text-center mb-4" style="color:#13315C; font-family: Georgia, 'Times New Roman', Times, serif;">NEW EL ALAMEIN CITY</h1>
            <div class="row">
                ...
                <div class="slider">
                        ...
                        <div class="products">
                            <div class="product-image">
                                <a href="product.php" class="images">
                                    <img src="../public/photos/nuweiba.jpg" alt="Concept 2 PM5 BikeErg" class="pic-1" width="500px">

                                    <img src="../public/photos/nweiba.jpg" alt="Concept 2 PM5 BikeErg" class="pic-2" width="500px">
                                </a>
                                <div class="links">
                                    <div class="Icon">
                            ...
                            <div class="Content">
                                <h3>nuweiba</h3>
                                <p class="detailsinfo">
                                    <span class="typetrip">ASWAN</span> <span class="separate"></span> <span class="nofdays">EGYPT</span>
                                </p>
                                <div class="cost">
                                    <p class="lower-price">
                    ...
                    <div class="col-md-3 ">
                        <div class="products">
                            <div class="product-image">
                                <a href="" class="images">
                                    <img src="../public/photos/siwa.jpg" alt="Concept 2 SkiErg" class="pic-1" width="500px">

                                    <img src="../public/photos/Siwa-Oasis-Egypt-1.webp" alt="Concept 2 SkiErg" class="pic-2" width="500px">
                                </a>
                                <div class="links">
                                    <div class="Icon">
                                        <a href="#"><i class="bi bi-cart3"></i></i></a>
                            ...
                            <div class="Content">
                                <h3>SIWA</h3>
                                <p class="detailsinfo">
                                    <span class="typetrip">SIWA</span> <span class="separate"></span> <span class="nofdays">EGYPT</span>
                                </p>
                                <div class="cost">
                                    <p class="lower-price">
                    ...
                    <div class="col-md-3 ">
                        <div class="products">
                            <div class="product-image">
                                <a href="" class="images">
                                    <img src="../public/photos/aswan1.jpg" alt="ASSAULT AIRBIKE" class="pic-1" width="500px">

                                    <img src="../public/photos/aswan2.jpg" alt="ASSAULT AIRBIKE" class="pic-2" width="500px">
                                </a>
                                <div class="links">
                                    <div class="Icon">
                                        <a href="#"><i class="bi bi-cart3"></i></i></a>
                            ...
                            <div class="Content">
                                <h3>ASWAN</h3>
                                <p class="detailsinfo">
                                    <span class="typetrip">EGYPT</span> <span class="separate"></span> <span class="nofdays">ASWAN</span>
                                </p>
                                <div class="cost">
                                    <p class="lower-price">
                    ...
                    <div class="col-md-3 ">
                        <div class="products">
                            <div class="product-image">
                                <a href="" class="images">
                                    <img src="../public/photos/alex.jpg" alt="Concept 2 SkiErg" class="pic-1" width="500px">

                                    <img src="../public/photos/dahab.jpg" alt="Concept 2 SkiErg" class="pic-2" width="500px">
                                </a>
                                <div class="links">
                                    <div class="Icon">
                                        <a href="#"><i class="bi bi-cart3"></i></i></a>
                            ...
                            <div class="Content">
                                <h3>DAHAB</h3>
                                <p class="detailsinfo">
                                    <span class="typetrip">EGYPT</span> <span class="separate"></span> <span class="nofdays">DAHAB</span>
                                </p>
                                <div class="cost">
                                    <p class="lower-price">
                                        From <span class="price">58.000 EGP</span>
    ...
    <div>
        <section class="featured-destinations py-5">
            <div class="container">
                ...
                <div class="row">
                    <div id="map">
                        <iframe src="map.html" frameborder="0" width="100%" height="700px"></iframe>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="social-wall-section" style="margin-bottom: 100px;">
        ...
        <p>Join the <a href="https://www.instagram.com/thisisegypt/" target="_blank">#Thisisegypt</a> community and post your experiences</p>
                        ...
                        <div class="overlay d-flex flex-column justify-content-center align-items-center">
                            <div class="quote mt-2 text-center align-items-center " style="margin-left: 30px;">
                                ...
                                <h5 class="custom-caption">Subscribe to the Newsletter so as not to miss places,
                                    events and experiences for experiencing the best side of Egypt: the authentic one.</h5>
                            </div>
                            <!-- newsettler Form -->
                            <form action="" id="ContactFooter" class="footer-form">
                                <div class="d-flex">
                                    <div class="form-floating me-2 custom-email-input">
                                        <input type="email" class="form-control border-0 custom-email-field" id="email" placeholder=" " style="background: transparent; color: #000;">
