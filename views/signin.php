        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="login" id="login" class="btn btn-lg start-50 rounded-pill">Sign in</button>
                    </div>
                </form>

                <div class="text-center mt-4">
                    <hr class="my-0" style="width: 80%; margin:auto;  margin-right: 40px;" />
                    <p class="mt-3">Not a member yet? <a href="../views/registeration.php" class="signup-link">Sign up</a></p>
                </div>
